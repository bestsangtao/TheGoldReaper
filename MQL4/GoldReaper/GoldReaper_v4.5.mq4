...
extern int   SetFontSize=0  ;    //SetFontSize (0 = default font size)
...
extern bool FridayClosePending=true  ;    //Friday close pending orders
extern bool FridayCloseOpen=true  ;    //Friday close open trades
...
extern bool ResetHighestBalance=false ;    //Reset stored highest balance (OnlyUp)
