...
// khong the sua ngay het han. Het han: bam OK cung khong chay duoc -
// EA tu rot khoi bieu do ngay (khong canh bao). Lenh dang mo van do
// broker quan ly SL/TP nhu binh thuong.
//====================================================================
...
g_startLots_rw=StartLots;
 if ( TimeCurrent() > GR_LICENSE_EXPIRY )   // het han: bam OK cung khong chay - EA rot ngay, khong vao lenh
