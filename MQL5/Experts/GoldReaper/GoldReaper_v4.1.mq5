...
//----- -----
 ...
 for (子_3_in = 子_2_in ; 子_3_in >= 0 ; 子_3_in --)
 {
   ...
   if ( OrderType() == 4 && OrderLots()!=总_223_do_1AC4_si99[总_328_in_3100] )
   {
     ...
     子_10_in = (int)OrderSend(总_336_st_3130,4,总_223_do_1AC4_si99[总_328_in_3100],子_7_do,总_38_do_C0,子_4_do,子_6_do,子_9_st,总_93_in_1F0,子_8_da,Green) ;
     临_lo_1 = 子_10_in;
     临_lo_2 = 子_5_lo;
     for (临_in_3 = 0 ; 临_in_3 < 100 ; 临_in_3=临_in_3 + 1)
     {
   ...
   子_17_in = (int)OrderSend(总_336_st_3130,5,总_223_do_1AC4_si99[总_328_in_3100],子_14_do,总_38_do_C0,子_11_do,子_13_do,子_16_st,总_93_in_1F0,子_15_da,Green) ;
   临_lo_4 = 子_17_in;
   临_lo_5 = 子_12_lo;
   for (临_in_6 = 0 ; 临_in_6 < 100 ; 临_in_6=临_in_6 + 1)
   {
...
//----- -----
 ...
 if ( WebRequest("GET","https://www.worldtimeserver.com/time-zones/utc/","User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36\r\n",10000,子_7_ch_ko,子_8_ch_ko,临_st_1) == -1 )
 {
