...
void MT4BuildLiveCache()
{
   ...
   for(int i=0;i<orders;i++)
   {
      ...
      g_live_orders[n].closeTime=0;
      g_live_orders[n].expiration=(datetime)::OrderGetInteger(ORDER_TIME_EXPIRATION);
...
//GetNextNFPFromCalendar <<==--------   --------
 ...
 datetime MT4HardcodedNFPForCurrentMonth()
 {
  ...
  for(int i=0;i<300;i++)
  {
    datetime event_time=总_391_da_5DFC_si300[i];
...
//init <<==--------   --------
 bool DumpBacktestSpeedAllowTick()
 {
  ...
  else
  {
    ...
    datetime 临_now = TimeCurrent();
    if ( 临_now < g_backtestSpeedLastProbeMinute + 60 )   return(false);
    datetime 临_minute = 临_now - (临_now % 60);
    g_backtestSpeedLastProbeMinute = 临_minute;
    临_skip = true;
  }
 ...
 if ( ( StringFind(Symbol(),"XAUUSD",0) >= 0 || StringFind(Symbol(),"xauusd",0) >= 0 || StringFind(Symbol(),"GOLD",0) >= 0 || StringFind(Symbol(),"GLD",0) >= 0 || StringFind(Symbol(),"gold",0) >= 0 || StringFind(Symbol(),"Gold",0) >= 0 ) )
 {
   ...
   if ( 总_20_bo_A0 )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_3 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_3);
         临_do_2 = 临_do_3;
       }
   ...
   if ( 总_27_bo_A7 )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_6 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_6);
         临_do_5 = 临_do_6;
       }
   ...
   if ( 总_23_bo_A3 )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_9 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_9);
         临_do_8 = 临_do_9;
       }
   ...
   if ( 总_26_bo_A6 )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_12 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_12);
         临_do_11 = 临_do_12;
       }
   ...
   if ( 总_28_bo_A8 )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_15 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_15);
         临_do_14 = 临_do_15;
       }
   ...
   if ( 总_31_bo_AB )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_18 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_18);
         临_do_17 = 临_do_18;
       }
   ...
   if ( 总_32_bo_AC )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_21 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_21);
         临_do_20 = 临_do_21;
       }
   ...
   if ( 总_33_bo_AD )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_24 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_24);
         临_do_23 = 临_do_24;
       }
   ...
   if ( 总_34_bo_AE )
   {
     ...
     if ( 子_4_bo )
     {
       ...
       {
         临_do_27 = 0.0;
         MT4HistoryStats(总_336_st_3130,总_93_in_1F0,总_343_in_372C_si99[总_328_in_3100],临_do_27);
         临_do_26 = 临_do_27;
       }
...
// Original V4.6 dump has no custom OnTradeTransaction withdrawal adjustment.
 ...
 // -----------------------------------------------------------------
 int 临_atr_index=木_0_in;
 if(临_atr_index<0 || 临_atr_index>8) 临_atr_index=0;
 ENUM_TIMEFRAMES 临_atr_tf=MT4Period(总_4_in_14);
 if(g_atr_handles[临_atr_index]<=0 ||
    g_atr_periods[临_atr_index]!=总_3_in_10 ||
    g_atr_timeframes[临_atr_index]!=临_atr_tf)
 {
   if(g_atr_handles[临_atr_index]>0) IndicatorRelease(g_atr_handles[临_atr_index]);
   g_atr_handles[临_atr_index]=iATR(总_336_st_3130,临_atr_tf,总_3_in_10);
   g_atr_periods[临_atr_index]=总_3_in_10;
   g_atr_timeframes[临_atr_index]=临_atr_tf;
   g_atr_checked_bars[临_atr_index]=0;
   g_atr_cached_values[临_atr_index]=0.0;
   g_atr_ready[临_atr_index]=false;
 }
 总_5_in_18 = g_atr_handles[临_atr_index];
 if ( 总_5_in_18 < 0 )
 {
 ...
 datetime 临_atr_bar=iTime(总_336_st_3130,临_atr_tf,0);
 if ( !(g_atr_ready[临_atr_index]) || g_atr_checked_bars[临_atr_index]!=临_atr_bar )
 {
   if ( CopyBuffer(总_5_in_18,0,0,2,总_6_do_1C_ko) == 0 )
   {
     return;
   }
   ArraySetAsSeries(总_6_do_1C_ko,true);
   // Original JIT contains the bounds check for element [1].
   g_atr_cached_values[临_atr_index]=总_6_do_1C_ko[1];
   g_atr_checked_bars[临_atr_index]=临_atr_bar;
   g_atr_ready[临_atr_index]=true;
 }
 总_2_do_8 = g_atr_cached_values[临_atr_index];
 ...
 if ( 总_7_do_50>=1000.0 )
 {
   临_variableRatio = iOpen(总_336_st_3130,MT4Period(PERIOD_D1),1) / 总_7_do_50 ;
 }
 if ( UseVariableValues )
 {
...
//----- -----
 ...
 bool 临_tradeAllowedForManagement = (MarketInfo(总_336_st_3130,MODE_TRADEALLOWED)!=0.0);
 if ( 总_99_in_22C == 0 )
 {
 ...
 if ( EnableNFP_Filter )
 {
   ...
   if ( 临_nfpLiveCalendar || Year() <= 2026 )
   {
     子_3_lo = 0 ;
     子_5_in = 0 ;
     ...
     if ( 临_nfpLiveCalendar )
     {
      ...
      {
        子_3_lo = MT4HardcodedNFPForCurrentMonth();
...
//lizong_12 <<==--------   --------
 double MT4FastEntryHigh(int timeframe)
 {
  ...
  int side=MathMax(总_73_in_17C,总_74_in_180);
  int count=总_77_in_188+side+2;
  double highs[];
  ArraySetAsSeries(highs,true);
  if(CopyHigh(总_336_st_3130,tf,0,count,highs)<count)
     return(lizong_11(timeframe));

  int candidate=总_74_in_180+1;
  do
  {
    bool left_ok=true;
    bool right_ok=true;
    double candidate_price=highs[candidate];
    for(int i=candidate;i>=candidate-总_74_in_180;i--)
      if(highs[i]>candidate_price) left_ok=false;
    for(int i=candidate;i<=candidate+总_73_in_17C;i++)
      if(highs[i]>candidate_price) right_ok=false;

    if(left_ok && right_ok && candidate_price>总_80_do_198*总_229_do_1E00+MarketInfo(总_336_st_3130,MODE_ASK))
    {
      ...
      {
        double normalized=NormalizeDouble(candidate_price,总_190_in_518);
        bool duplicate=false;
        for(int i=MT4OrdersTotal();i>=0;i--)
        {
          if(OrderSelect(i,0,0)!=true || OrderMagicNumber()!=总_93_in_1F0 ||
             OrderSymbol()!=总_336_st_3130 || OrderType()!=4 ||
             !(MathAbs(OrderOpenPrice()-(总_83_do_1B0*总_229_do_1E00+normalized))<总_88_do_1D0*总_229_do_1E00)) continue;
          duplicate=true;
          break;
        }
        if(!duplicate && (!总_75_bo_184 || !(iClose(总_336_st_3130,tf,candidate-1)>candidate_price-总_80_do_198*总_229_do_1E00)))
        {
          总_262_do_2580=normalized;
          总_265_in_2598=candidate;
          return(总_262_do_2580);
        }
      }
    }
    candidate++;
    if(candidate<=总_77_in_188) continue;
    总_262_do_2580=0.0;
    break;
  }
  while(true);
 ...
 double MT4FastEntryLow(int timeframe)
 {
  ...
  if(CopyLow(总_336_st_3130,tf,0,count,lows)<count)
     return(lizong_12(timeframe));
  ...
  do
  {
    ...
    if(left_ok && right_ok && candidate_price<MarketInfo(总_336_st_3130,MODE_BID)-总_80_do_198*总_229_do_1E00)
    {
      ...
      if(candidate_price<=range_low)
      {
        ...
        {
          if(OrderSelect(i,0,0)!=true || OrderMagicNumber()!=总_93_in_1F0 ||
             OrderSymbol()!=总_336_st_3130 || OrderType()!=5 ||
             !(MathAbs(OrderOpenPrice()-(normalized-总_84_do_1B8*总_229_do_1E00))<总_88_do_1D0*总_229_do_1E00)) continue;
          duplicate=true;
          break;
        }
        if(!duplicate && (!总_75_bo_184 || !(iClose(总_336_st_3130,tf,candidate-1)<总_80_do_198*总_229_do_1E00+candidate_price)))
        {
          总_261_do_2578=normalized;
          总_266_in_259C=candidate;
          return(总_261_do_2578);
        }
      }
    }
...
//----- -----
 ...
 do
 {
   ...
   if ( 子_5_bo && 子_4_bo && iHigh(总_336_st_3130,MT4Period(木_0_in),子_6_in)>总_221_do_1A80 + MarketInfo(总_336_st_3130,MODE_ASK) )
   {
     子_2_bo = true ;
...
//----- -----
 ...
 do
 {
   ...
   if ( 子_5_bo && 子_4_bo && iLow(总_336_st_3130,MT4Period(木_0_in),子_6_in)<MarketInfo(总_336_st_3130,MODE_BID) - 总_221_do_1A80 )
   {
     子_2_bo = true ;
 ...
 if ( 木_0_in == 1 )
 {
   ...
   if ( 子_2_bo )
   {
     ...
     if ( !(总_67_bo_158) )
     {
       ...
       if ( MarketInfo(总_336_st_3130,MODE_ASK)<子_4_do - 总_309_do_2898 && MarketInfo(总_336_st_3130,MODE_ASK)<子_4_do - 总_221_do_1A80 )
       {
 ...
 if ( 木_0_in == 1 )
 {
   ...
   if ( 子_2_bo )
   {
     ...
     if ( !(总_67_bo_158) )
     {
       ...
       if ( MarketInfo(总_336_st_3130,MODE_BID)>总_309_do_2898 + 子_4_do && MarketInfo(总_336_st_3130,MODE_BID)>总_221_do_1A80 + 子_4_do )
       {
         if ( !(setSL_TP_After_Entry) )
         {
         ...
         if ( ( 总_63_in_140 == 1 || (总_63_in_140 != 3 && 总_63_in_140 != 2) ) )
         {
           ...
           if ( 总_125_do_2F8>0.0 && TimeCurrent() >= 子_13_da + 总_304_in_287C && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_126_do_300 * 总_229_do_1E00 + (子_7_do + 总_337_do_3140),总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)<子_8_do - 总_309_do_2898 )
           {
             ...
             if ( 子_7_do<MarketInfo(总_336_st_3130,MODE_BID) - 总_221_do_1A80 )
             {
               ...
               if ( 总_230_in_1E08 <= 0 )
               {
                 Print("TrailStop error: \'" + lizong_21(MT4_LastError()) + "\' when setting trailing Exit_TrailSL_after_X_Minutes_size_ loss.  Trying again!"); 
               }
               子_2_bo = true ;
             }
           }
           if ( 总_103_do_250>0.0 && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble((总_103_do_250 + 总_106_do_268) * 总_229_do_1E00 + (子_7_do + 总_337_do_3140),总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_104_do_258 * 总_229_do_1E00 + 子_10_do,总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)<子_8_do - 总_309_do_2898 && 子_7_do<NormalizeDouble(总_105_do_260 * 总_229_do_1E00 + 子_10_do,总_190_in_518) )
           {
             ...
             if ( 子_7_do<MarketInfo(总_336_st_3130,MODE_BID) - 总_221_do_1A80 )
             {
               ...
               if ( 总_230_in_1E08 <= 0 )
               {
                 Print("TrailStop error: \'" + lizong_21(MT4_LastError()) + "\' when setting trailing Exit_stop_ loss.  Trying again!"); 
               }
               else
               {
           ...
           if ( 总_110_do_288>0.0 && MarketInfo(总_336_st_3130,MODE_ASK)<NormalizeDouble(子_8_do - 总_337_do_3140 - 总_110_do_288 * 总_229_do_1E00,总_190_in_518) && MarketInfo(总_336_st_3130,MODE_ASK)<NormalizeDouble(子_5_do - 总_111_do_290 * 总_229_do_1E00,总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)<子_8_do - 总_309_do_2898 )
           {
             子_8_do = NormalizeDouble(MarketInfo(总_336_st_3130,MODE_BID) + 总_110_do_288 * 总_229_do_1E00,总_190_in_518) ;
           ...
           if ( 总_113_do_2A8>0.0 && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_113_do_2A8 * 总_229_do_1E00 + 子_10_do,总_190_in_518) && NormalizeDouble(总_114_do_2B0 * 总_229_do_1E00 + 子_10_do,总_190_in_518)>子_7_do + 总_337_do_3140 && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_114_do_2B0 * 总_229_do_1E00 + 子_10_do + 总_221_do_1A80,总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)<子_8_do - 总_309_do_2898 )
           {
             ...
             if ( 子_7_do<MarketInfo(总_336_st_3130,MODE_BID) - 总_221_do_1A80 )
             {
               ...
               if ( 总_230_in_1E08 <= 0 )
               {
                 Print("error when setting breakeven: \'" + lizong_21(MT4_LastError()) + "\' ..\'Exit_BE_start_\' to close to \'Exit_BE_extra_pips_\' ..trying again!"); 
               }
               子_2_bo = true ;
             }
           }
     ...
     if ( 子_14_in == 1 && ( ( 子_15_in == 总_93_in_1F0 && 总_69_in_160 == 1 && 子_16_st == 总_336_st_3130 ) || (总_69_in_160 == 2 && ( 总_95_in_204 == 0 || (总_95_in_204 == 1 && 子_16_st == 总_336_st_3130) ) && ( 子_15_in == 总_96_in_208 || 总_96_in_208 == 0 ) && (子_11_st == 总_97_st_210 || 总_97_st_210 == "")) ) )
     {
       ...
       if ( !(子_20_bo) )
       {
         if ( ( 总_63_in_140 == 1 || (总_63_in_140 != 2 && 总_63_in_140 != 3) ) )
         {
           ...
           if ( 总_110_do_288>0.0 && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_110_do_288 * 总_229_do_1E00 + (子_8_do + 总_337_do_3140),总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)>NormalizeDouble(总_111_do_290 * 总_229_do_1E00 + 子_5_do,总_190_in_518) && MarketInfo(总_336_st_3130,MODE_BID)>子_8_do + 总_309_do_2898 )
           {
             子_8_do = NormalizeDouble(MarketInfo(总_336_st_3130,MODE_BID) - 总_110_do_288 * 总_229_do_1E00,总_190_in_518) ;
...
//----- -----
 ...
 子_2_do = 木_0_do ;
 string 临_account_currency=AccountInfoString(ACCOUNT_CURRENCY);
 if(临_account_currency=="USD" || 临_account_currency=="usd")
 {
   return(MathRound(木_0_do));
 }
...
//----- -----
 ...
 {
   if ( OrderSelect(临_in_3,0,0) != true || OrderSymbol() != 总_336_st_3130 ) continue;
   int 临_daily_magic=OrderMagicNumber();
   if(临_daily_magic<ST1_MagicNumber+1 || 临_daily_magic>ST1_MagicNumber+15) continue;
   if(OrderType()!=4 && OrderType()!=5) continue;
   OrderDelete(OrderTicket(),Red);
 }
 总_382_bo_5D98 = true ;
...
//----- -----
 ...
 datetime 临_now=TimeCurrent();
 datetime 临_day=临_now-(临_now%86400);
 if ( g_us_dst_cache_valid && g_us_dst_cache_day==临_day )
 {
   return(g_us_dst_cache_value);
 }
 子_2_in = TimeYear(临_now) ;
 子_3_da = 0 ;
 子_4_da = 0 ;
 if ( 子_2_in <  1987 )
 {
 ...
 g_us_dst_cache_value=(TimeDayOfYear(临_now)>TimeDayOfYear(子_3_da) &&
                       TimeDayOfYear(临_now)<TimeDayOfYear(子_4_da));
 g_us_dst_cache_day=临_day;
